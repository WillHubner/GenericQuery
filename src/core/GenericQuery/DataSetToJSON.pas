...
//  End;
  ...
  TDataSetToJSON = Class(TInterfacedObject, iDataSetToJSON)
  public
    constructor Create;
    destructor Destroy; override;

    class function New : iDataSetToJSON;
...
function TDataSetToJSON.DataSetToJSONArray(DataSet : TDataSet) : TJSONArray;
var
  bookMark: TBookmark;
begin
  Result := nil;
...
function TDataSetToJSON.DataSetToJSONObject(DataSet : TDataSet) : TJSONObject;
var
  i: Integer;
  key : string;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        key := LowerCase(dataSet.Fields[i].FieldName);
        case dataSet.Fields[i].DataType of
          TFieldType.ftBoolean:
            begin
              bft := TBooleanFieldType(TBooleanField(dataSet.Fields[i]));
              case bft of
...
class function TDataSetToJSON.New: iDataSetToJSON;
begin
  Result := Self.Create;
end;
